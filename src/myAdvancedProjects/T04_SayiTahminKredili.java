            ...
            do {
                ...
                if (sayi == tahmin) {
                    ...
                    if (kredi <= 30 && ekstraOyunHakki == 1) {
                        ekstraOyunHakki++;
                        System.out.println(
                                "Kredi miktariniz kritik seviyeye indi. Mevcut krediniz ile " +
                                        "yeni bir oyunabaslamak ister misiniz? Boylelikle bonuslardan " +
                                        "tekrardan yararlanma hakkina sahip olabilirsiniz. Evet icin 1'i " +
                                        "Hayir icin 2'yi tuslayin.");
